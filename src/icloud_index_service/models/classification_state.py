...
class ClassificationState(Base):
    ...
    entity_summary: Mapped[str | None] = mapped_column(Text, default=None)
    topic_summary: Mapped[str | None] = mapped_column(Text, default=None)
    retrieval_terms_json: Mapped[str | None] = mapped_column(Text, default=None)
    retrieval_text: Mapped[str | None] = mapped_column(Text, default=None)
