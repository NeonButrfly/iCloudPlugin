...
def main() -> int:
    ...
    parser.add_argument("--model", default=os.environ.get("CLASSIFY_MODEL", "qwen2.5:7b"))
    parser.add_argument("--vision-model", default=os.environ.get("VISION_MODEL", "qwen2.5vl:7b"))
